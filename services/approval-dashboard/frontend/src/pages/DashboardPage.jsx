        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <select
              ...
              className="px-4 py-3 bg-white/5 border border-white/10 rounded-full text-white focus:outline-none focus:ring-2 focus:ring-white/20 backdrop-blur-xl appearance-none cursor-pointer [&>option]:bg-gray-900 [&>option]:text-white"
            >
